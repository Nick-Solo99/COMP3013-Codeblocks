    ...
    return (
        <div className="hero mt-4">
            <div className="card bg-base-200 p-5">
                <h2 className="text-4xl text-primary font-semibold text-center">Edit Block</h2>
                <form className="card-body" method="POST" action="#">
                    <fieldset className="fieldset border-primary rounded-box w-xs border p-4">
                        ...
                        <select className="select" id="sel_lang" name="sel_lang" defaultValue={block?.lang}>
                        ...
                        <textarea
                            ...
                            name="code"
                            id="code"
                            defaultValue={block?.code}></textarea>
